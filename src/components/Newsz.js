...
const Newsz = (props) => {
    ...
    const updateNews = async () => {
        ...
        const url = `https://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&apiKey=${props.apiKeyz}&page=${page}&pageSize=${props.pageSize}`;
        setLoading(true)
                ...
                localStorage.getItem("token") ?
                    <div>
                        <div style={{ height: "100vh" }}>
                            <div className='container' style={{ height: "90.2%", width: "100%" }}>
