...
import NewsItemReader from './NewsItemReader'
            ...
            <div>
                <div style={{ height: "100vh" }}>
                    <div className='container' style={{ textDecoration:"none", height: "90.2%", width: "100%" }}>
                        ...
                        {/* <div style={{ marginTop: "2.5em", display: "flex", borderBottom: "1px solid rgb(149 146 159 / 32%)" }}>
                            <p className='text-center' style={{ width: "50%", marginTop: "8px", fontSize: "1.5rem", fontWeight: "bold", borderRight: "1px solid rgb(149 146 159 / 32%)", cursor: "pointer" }}>My neuus</p>
                            <p className='text-center' style={{ width: "50%", marginTop: "8px", fontSize: "1.5rem", fontWeight: "bold", cursor: "pointer" }}>Trending</p>
                        </div> */}
                        {/* <hr /> */}
                        {/* <div style={{ margin: '0px 0px', marginTop: '0px' }}></div> */}
                        {loading && <Spinner />}
                        <InfiniteScroll
                                ...
                                <div className="row">
                                    {articles.map((element) => {
                                        return <div className="container" key={element.url}>
                                            <NewsItemReader title={element.title ? element.title : ""} description={element.description ? element.description : ""} imageUrl={element.urlToImage} newsUrl={element.url} author={element.author} date={element.publishedAt} source={element.source.name} content={element.content} />
                                        </div>
                                    })}
                                </div>
                            </div>
